...
resource "aws_security_group" "subhra_grp_r" {
  name         = "subhra_grp_r"
...
resource "null_resource" "nullremote21" {
  ...
  provisioner "remote-exec" {
   ...
   "sudo git clone https://github.com/subhra111/AWS-Terraform.git  /var/www/html/"
         ]
   }
}
...
resource "aws_s3_bucket" "my_bucket" {
  bucket = "my-tf-test-bucket-subhra"
  acl    = "public-read"
...
resource "aws_s3_bucket_object" "object" {
  ...
  key    = "subhra.jpeg"
  source = "C:/Users/Downloads/subhra.jpeg"
  acl    = "public-read"
...
resource "aws_s3_bucket_object" "object1" {
  ...
  source = "C:/Users/Downloads/videoplayback.mp4"
  acl    = "public-read"
  depends_on = [
    aws_s3_bucket.my_bucket,
  ]
